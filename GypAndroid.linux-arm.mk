...
include $(LOCAL_PATH)/android_webview/android_webview_version.target.linux-arm.mk
...
include $(LOCAL_PATH)/base/base_java_library_load_from_apk_status_codes.target.linux-arm.mk
include $(LOCAL_PATH)/base/base_java_memory_pressure_level.target.linux-arm.mk
...
include $(LOCAL_PATH)/components/data_reduction_proxy_core_browser.target.linux-arm.mk
include $(LOCAL_PATH)/components/data_reduction_proxy_core_common.target.linux-arm.mk
...
include $(LOCAL_PATH)/content/browser/devtools/devtools_protocol_handler.target.linux-arm.mk
...
include $(LOCAL_PATH)/content/top_controls_state_java.target.linux-arm.mk
include $(LOCAL_PATH)/courgette/courgette_lib.target.linux-arm.mk
include $(LOCAL_PATH)/crypto/crypto.target.linux-arm.mk
include $(LOCAL_PATH)/device/battery/device_battery.target.linux-arm.mk
include $(LOCAL_PATH)/device/battery/device_battery_jni_headers.target.linux-arm.mk
include $(LOCAL_PATH)/device/battery/device_battery_mojo_bindings.target.linux-arm.mk
...
include $(LOCAL_PATH)/media/media_android_imageformat.target.linux-arm.mk
...
include $(LOCAL_PATH)/mojo/edk/mojo_js_lib.target.linux-arm.mk
include $(LOCAL_PATH)/mojo/edk/mojo_system_impl.target.linux-arm.mk
include $(LOCAL_PATH)/mojo/libmojo_system_java.target.linux-arm.mk
...
include $(LOCAL_PATH)/mojo/mojo_java_set_jni_headers.target.linux-arm.mk
include $(LOCAL_PATH)/mojo/mojo_jni_headers.target.linux-arm.mk
include $(LOCAL_PATH)/mojo/mojo_none.target.linux-arm.mk
include $(LOCAL_PATH)/mojo/public/mojo_application_bindings.target.linux-arm.mk
include $(LOCAL_PATH)/mojo/public/mojo_cpp_bindings.target.linux-arm.mk
include $(LOCAL_PATH)/mojo/public/mojo_js_bindings.target.linux-arm.mk
...
include $(LOCAL_PATH)/third_party/WebKit/Source/bindings/core/v8/bindings_core_impl_generated.target.linux-arm.mk
...
include $(LOCAL_PATH)/third_party/WebKit/Source/bindings/modules/v8/bindings_modules_impl_generated.target.linux-arm.mk
...
include $(LOCAL_PATH)/third_party/WebKit/Source/bindings/modules/v8/bindings_modules_v8_generated_init_partial.target.linux-arm.mk
include $(LOCAL_PATH)/third_party/WebKit/Source/bindings/modules/v8/bindings_modules_v8_generated_partial_aggregate.target.linux-arm.mk
include $(LOCAL_PATH)/third_party/WebKit/Source/bindings/modules/v8/bindings_modules_v8_generated_partial_individual.target.linux-arm.mk
...
include $(LOCAL_PATH)/third_party/webrtc/modules/video_coding/codecs/vp9/webrtc_vp9.target.linux-arm.mk
...
include $(LOCAL_PATH)/third_party/zlib/zlib_x86_simd.target.linux-arm.mk
