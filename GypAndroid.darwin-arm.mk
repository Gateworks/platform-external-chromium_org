...
include $(LOCAL_PATH)/base/base_java_library_load_from_apk_status_codes.target.darwin-arm.mk
include $(LOCAL_PATH)/base/base_java_memory_pressure_level.target.darwin-arm.mk
...
include $(LOCAL_PATH)/components/data_reduction_proxy_core_browser.target.darwin-arm.mk
include $(LOCAL_PATH)/components/data_reduction_proxy_core_common.target.darwin-arm.mk
...
include $(LOCAL_PATH)/content/browser/devtools/devtools_protocol_handler.target.darwin-arm.mk
...
include $(LOCAL_PATH)/media/media_android_imageformat.target.darwin-arm.mk
...
include $(LOCAL_PATH)/mojo/edk/mojo_js_lib.target.darwin-arm.mk
include $(LOCAL_PATH)/mojo/edk/mojo_system_impl.target.darwin-arm.mk
include $(LOCAL_PATH)/mojo/libmojo_system_java.target.darwin-arm.mk
...
include $(LOCAL_PATH)/mojo/mojo_java_set_jni_headers.target.darwin-arm.mk
include $(LOCAL_PATH)/mojo/mojo_jni_headers.target.darwin-arm.mk
include $(LOCAL_PATH)/mojo/mojo_none.target.darwin-arm.mk
include $(LOCAL_PATH)/mojo/public/mojo_application_bindings.target.darwin-arm.mk
include $(LOCAL_PATH)/mojo/public/mojo_cpp_bindings.target.darwin-arm.mk
include $(LOCAL_PATH)/mojo/public/mojo_js_bindings.target.darwin-arm.mk
...
include $(LOCAL_PATH)/third_party/WebKit/Source/bindings/modules/v8/bindings_modules_v8_generated_init_partial.target.darwin-arm.mk
include $(LOCAL_PATH)/third_party/WebKit/Source/bindings/modules/v8/bindings_modules_v8_generated_partial_aggregate.target.darwin-arm.mk
include $(LOCAL_PATH)/third_party/WebKit/Source/bindings/modules/v8/bindings_modules_v8_generated_partial_individual.target.darwin-arm.mk
